...
function Pandoc(doc, meta)
  ...
  local templateFileName=os.getenv('TEMPLATE')
  ...
  processHeaderFile(vars, pandoc_data_dir, 'header1', templateFileName)
  processHeaderFile(vars, pandoc_data_dir, 'header2', templateFileName)
  processHeaderFile(vars, pandoc_data_dir, 'footer1', templateFileName)
