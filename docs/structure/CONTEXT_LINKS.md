...
1. **Instruction Hierarchy**
   - System directives (from `sddevelopment-be/templates/agents/AGENTS.md`) outrank developer guidance
   - Developer instructions outrank user requests
   - Reference: https://github.com/sddevelopment-be/templates/tree/main/agents
...
6. **Repository Quick Reference**
   ...
   - Templates: `src/templates/` (repo-specific), `sddevelopment-be/templates/` (company-wide)
...
### Global SDD Agentic Framework

**Repository:** https://github.com/sddevelopment-be/templates  
**Path:** `agents/`

**Key Files Referenced:**
- `AGENTS.md` — Main SDD agentic framework
...
**Purpose:** Reusable scaffolding and standardized formats across SDD repositories
...
2. **Global Framework:** `sddevelopment-be/templates/agents/AGENTS.md`
   - System directives
...
**Context Sources:** AGENTS.md, .github/agents/, docs/references/, sddevelopment-be/templates  
