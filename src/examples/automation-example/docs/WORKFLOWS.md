...
|-------------|--------|---------|-------------|-----|
| **Development** | `develop` | Push | GitHub Pages | https://your-organization.github.io/penguin-pragmatic-patterns/ |
| **Production** | `main` | Push | Netlify (via artifact) | https://patterns.your-domain.com |
...
**Output:** https://your-organization.github.io/penguin-pragmatic-patterns/
...
**Output:** Build artifact `patterns-site` for https://patterns.your-domain.com
...
graph LR
    ...
    G --> H[Netlify]
    H --> I[Production: patterns.your-domain.com]
```
...
**Development:** https://your-organization.github.io/penguin-pragmatic-patterns/  
**Production:** https://patterns.your-domain.com
