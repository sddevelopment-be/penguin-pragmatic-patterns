...
{{< stub text=`Description of the problem that this pattern aims to solve.` >}}

## Intent

{{< stub text=`Description of the desired outcome, focussing on the goals and expectations (supported values) of applying the pattern.` >}}

## Solution

{{< stub text=`Describe the core idea of the pattern and how to apply it.  
...
{{< stub text=`The reasoning behind the pattern, or go into more detail on why it works.` >}}
...
{{< stub text=`Case-studies, testimonials, or other examples that illustrate the pattern in action.` >}}
